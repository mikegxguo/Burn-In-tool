 ...
 * Time: 下午6:37
 */
public class INANDTest extends TestClass {

    private File folder;

    private boolean keepTheDiffer;

    public INANDTest(Messenger messenger, Activity activity, boolean isContinuous, boolean keepTheDiffer) {
        super(messenger, activity, isContinuous);
        this.id = BISTApplication.INANDTest_ID;
...
//        this.logFile = new File(BISTApplication.LOG_PATH, "BIST_Testlog.txt");
    ...
    public INANDTest(Messenger messenger, Activity activity, int cycles, boolean keepTheDiffer) {
